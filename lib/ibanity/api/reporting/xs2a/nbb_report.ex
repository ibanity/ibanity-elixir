defmodule Ibanity.Reporting.Xs2a.NbbReport do
  ...
  def key_mapping do
    [
      ...
      account_information_accounts: {~w(attributes accountInformationAccounts), :integer},
      account_information_synchronization_count: {~w(attributes accountInformationSynchronizationCount), :integer},
      payment_initiation_accounts: {~w(attributes paymentInitiationAccounts), :integer},
      payment_initiations: {~w(attributes paymentInitiations), :integer}
    ]
  end
end
