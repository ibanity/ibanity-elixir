defmodule Ibanity.Xs2a.PendingTransaction do
  @moduledoc """
  [PendingTransactions](https://documentation.ibanity.com/xs2a/api#transaction) API wrapper
  """
  ...
  @doc """
  [Retrieves a pending transaction](https://documentation.ibanity.com/xs2a/api#get-pending-transaction)
  linked to an account belonging to an account, based on its id.

  Returns `{:ok, pending_transaction}` if successful, {:error, reason} otherwise.
  ...
  ## Example
      ...
      {:ok, %Ibanity.Xs2a.PendingTransaction{id: "9536e9f2-4ee6-4336-b035-40fc2a0424e4", ...}}
