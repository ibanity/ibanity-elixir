defmodule Ibanity.Xs2a.TransactionDeleteRequest do
  ...
  @doc """
  Creates a new transaction delete request for:
  - [financial institution and account](https://documentation.ibanity.com/xs2a/api#create-transaction-delete-request-for-account)
  - [application](https://documentation.ibanity.com/xs2a/api#create-transaction-delete-request-for-application)
  - [customer](https://documentation.ibanity.com/xs2a/api#create-transaction-delete-request-for-customer)

  Returns `{:ok, transaction_delete_request}` if sucessful, `{:error, reason}` otherwise.

  ## Example

  Transaction delete request for financial institution and account:
  ...
  Transaction delete request for application:
  ...
  Transaction delete request for customer:
