defmodule Ibanity.Webhooks.Xs2a.BulkPaymentInitiationRequest.AuthorizationCompleted do
  @moduledoc """
  xs2a.bulkPaymentInitiationRequest.authorizationCompleted webhook event
  """
