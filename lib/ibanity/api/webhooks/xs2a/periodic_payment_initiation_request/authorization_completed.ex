defmodule Ibanity.Webhooks.Xs2a.PeriodicPaymentInitiationRequest.AuthorizationCompleted do
  @moduledoc """
  xs2a.periodicPaymentInitiationRequest.authorizationCompleted webhook event
  """
